...
export const FreeFooter: React.FunctionComponent = () => {
  return (
    <FooterWrapper>
      <a
        href="https://www.courier.com/features/preferences/?utm_campaign=preferences-center&utm_source=hosted-preferences-center&utm_term=footer-banner"
        target="_blank"
      >
        <CourierWrapper>
          <h1>Notifications powered by</h1>
          <svg
