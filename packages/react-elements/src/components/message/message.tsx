...
const Message: React.FunctionComponent<{
  ...
  renderPin?: any; //InboxProps["renderPin"];
  title?: string;
}> = ({
  actions,
  archived,
...
const MessageWrapper: React.FunctionComponent<
  IInboxMessagePreview & {
    defaultIcon: any; //InboxProps["defaultIcon"];
    formatDate: any; //InboxProps["formatDate"];
    isMessageFocused: boolean;
    isMobile?: boolean;
    labels: any; //InboxProps["labels"];
    openLinksInNewTab: any; //InboxProps["openLinksInNewTab"];
    renderActionsAsButtons?: boolean;
    renderPin: any; //InboxProps["renderPin"];
